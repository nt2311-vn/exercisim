...
public class NeedForSpeedTest {
  ...
  @Tag("task:5")
  @DisplayName(
      "The batteryDrained method returns false when nitro battery did not completely drain after"
          + " driving")
  ...
  @Tag("task:5")
  @DisplayName(
      "The batteryDrained method returns true when nitro battery completely drained after driving")
