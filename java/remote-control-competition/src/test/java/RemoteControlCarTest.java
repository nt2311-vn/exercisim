...
public class RemoteControlCarTest {
  ...
  @Tag("task:2")
  @DisplayName(
      "The getDistanceTravelled method of the ProductionRemoteControlCar returns 10 after driving"
          + " once")
  ...
  @Tag("task:2")
  @DisplayName(
      "The getDistanceTravelled method of the ExperimentalRemoteControlCar returns 20 after driving"
          + " once")
  ...
  public void race() {
    ...
    TestTrack.race((RemoteControlCar) experimentalCar);
    assertThat(experimentalCar.getDistanceTravelled() - productionCar.getDistanceTravelled())
        .isEqualTo(20);
  }
  ...
  public void rankTwoCars() {
    List<ProductionRemoteControlCar> unsortedCars =
        new ArrayList<>() {
          {
